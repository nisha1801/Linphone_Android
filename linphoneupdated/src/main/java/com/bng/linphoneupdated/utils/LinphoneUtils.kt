...
class LinphoneUtils {
    companion object {
            ...
            return if (conference.subject.isNullOrEmpty()) {
                ...
                if (conferenceInfo != null) {
                    ...
                    if (conference.me.isFocus) {
                        AppUtils.getString(com.bng.linphoneupdated.R.string.conference_local_title)
                    } else {
                        AppUtils.getString(com.bng.linphoneupdated.R.string.conference_default_title)
                    }
                }
            } else {
                conference.subject
        ...
        fun createOneToOneChatRoom(participant: Address, isSecured: Boolean = false): ChatRoom? {
            ...
            if (isSecured) {
                params.subject = AppUtils.getString(com.bng.linphoneupdated.R.string.chat_room_dummy_subject)
